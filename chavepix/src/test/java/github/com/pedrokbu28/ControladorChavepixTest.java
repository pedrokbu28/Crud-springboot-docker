...
public class ControladorChavepixTest {
    ...
    public void deveBuscarChavepix() throws Exception {
        ...
        Mockito.when(chavepixService.listar()).thenReturn(List.of(chavepixEsperado));
    ...
    public void deveCriarChavepix() throws Exception {
        ...
        //when = quando = Execução
        when(chavepixService.salvar(any(ChavepixApplication.class))).thenReturn(chavepixSalvar);
